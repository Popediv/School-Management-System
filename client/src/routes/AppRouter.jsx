...
import BillLetterPage from '../pages/fees/BillLetterPage';
import LedgerPage from '../pages/fees/LedgerPage';
        ...
        <SettingsProvider>
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/fees/letters" element={
                <ProtectedRoute roles={[ROLES.BURSARY, ROLES.SUPER_ADMIN, ROLES.PRINCIPAL]}>
                  <DashboardLayout><BillLetterPage /></DashboardLayout>
                </ProtectedRoute>
              } />
