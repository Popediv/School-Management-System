...
router.get('/moodle-import', allowRoles('SUPER_ADMIN'), ctrl.exportCustomMoodle);
router.get('/pictures-zip', allowRoles('SUPER_ADMIN', 'PRINCIPAL'), ctrl.exportPicturesZip);
